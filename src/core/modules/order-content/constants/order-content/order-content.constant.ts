...
// import { ORDER_CONTENT_PSEUDO_CLASSES } from './constants/order-content-pseudo-classes.constant';
// import { ORDER_CONTENT_PSEUDO_ELEMENT_INCLUDES } from './constants/order-content-pseudo-elements-includes.constant';
// import { ORDER_CONTENT_PSEUDO_CLASS_INCLUDES } from './constants/order-content-pseudo-class-includes.constant';
...
export const ORDER_CONTENT = [
	...
	// /**
	//  * SCSS Media includes:
	//  * @example: @include media-min(md); or @include media-desktop;
	//  */
	// MEDIA_ORDER,
	// /**
	//  * Media queries:
